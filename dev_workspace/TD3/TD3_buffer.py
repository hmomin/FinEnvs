...
class Buffer(BaseObject):
    def __init__(
        ...
        self.container: Dict[str, torch.Tensor] = {
            ...
            "state_action_values_target_1": None,
            "state_action_values_target_2": None,
        }
        self.batch_keys = [
            "states",
            "actions",
    ...
    def store(
        ...
        self.store_tensor("target_actions", target_actions)
        self.store_tensor("state_action_values_1", state_action_values_1)
        self.store_tensor("state_action_values_2", state_action_values_2)
        self.store_tensor("state_action_values_target_1", state_action_values_target_1)
        self.store_tensor("state_action_values_target_2", state_action_values_target_2)
