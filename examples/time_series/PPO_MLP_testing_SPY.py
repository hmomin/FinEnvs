import os
import torch
from finenvs.agents.PPO.continuous_actor import ContinuousActorMLP
from finenvs.environments.time_series_env import TimeSeriesEnv
from re import findall

relative_trials_dir = "../trials/SPY_PPO_2022-06-19_22-23-52"
...
def test_MLP_on_evaluation_enviroments(env_name: str):
    ...
    test_actor = ContinuousActorMLP(actor_shape)
